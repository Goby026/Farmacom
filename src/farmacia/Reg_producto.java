...
public final class Reg_producto extends javax.swing.JFrame {
    ...
    public void cargarTituloTabla1() {
        String[] cabecera1 = {"ID", "CODIGO","NOMBRE", "CONCENTRACION","PRESENTACIÓN", "P. VENTA","LABORATORIO", "STOCK","LOTE"};
                    ...
                    txtNewConcentracion.transferFocus(); 
                            if (!txtNewPresentacion.getText().trim().isEmpty()) {
                                txtNewPresentacion.transferFocus();
                                    if (!txtNewFraccion.getText().trim().isEmpty()) {
                                        txtNewFraccion.transferFocus();
                    ...
                    txtModConcentracion.transferFocus();
                            if (!txtModPresentacion.getText().trim().isEmpty()) {
                                txtModPresentacion.transferFocus();
                                    if (!txtModFraccion.getText().trim().isEmpty()) {
                                        txtModFraccion.transferFocus();
        ...
        try {
            ...
            if (rs.next()) {
               ...
               // txtModFormato.setText(rs.getString("nom_form_farm_pro_medi"));
                ...
                txtModFraccion.setText(rs.getString("num_reg_sanit_pro_medi"));
...
public void actualizarProductoEnBD(){
       ...
       // String formato = txtModFormato.getText();
        ...
        String sql = "UPDATE `tproducto_medicamento` SET `cod_prod`= '"+codigo+"',`nom_pro_medi`='"+nombre+"',`concentracion_pro_medi`='"+concentracion+"',`presentacion_pro_medi`='"+presentacion+"',`fecha_venc_pro_medi`= '"+fecha+"',`fraccion_pro_medi`='"+fraccion+"',lote='"+lote+"',`provee_labo_pro_medi`='"+prove+"',`prec_venta`="+prec_uni+",`stock_pro_medi`="+stock+" WHERE  id_pro_medi = " + idprod;
        try {
            Statement st = cc.createStatement();
    ...
    private void initComponents() {
        ...
        txtModFraccion = new javax.swing.JTextField();
        ...
        txtNewFraccion = new javax.swing.JTextField();
        ...
        txtModFraccion.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        txtModFraccion.setForeground(new java.awt.Color(0, 102, 255));
        txtModFraccion.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtModFraccion.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 102, 255), 1, true));
        txtModFraccion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtModFraccionActionPerformed(evt);
            }
        });
        jPanel4.add(txtModFraccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 255, -1));
        ...
        txtNewFraccion.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        txtNewFraccion.setForeground(new java.awt.Color(0, 51, 255));
        txtNewFraccion.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNewFraccion.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 255), 1, true));
        txtNewFraccion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNewFraccionActionPerformed(evt);
            }
        });
        jPanel2.add(txtNewFraccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 200, 255, -1));

        jLabel37.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel37.setForeground(new java.awt.Color(0, 0, 102));
        jLabel37.setText("FRACCION");
    ...
    private void txtNewFraccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNewFraccionActionPerformed
       txtNewLote.requestFocus();
             
    }//GEN-LAST:event_txtNewFraccionActionPerformed
   ...
   public void eliminarDetalleVenta(int idproducto){
    ...
    private void txtModFraccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtModFraccionActionPerformed
        txtModPrecVenta.requestFocus();
    }//GEN-LAST:event_txtModFraccionActionPerformed
    ...
    private javax.swing.JTextField txtModFraccion;
    ...
    private javax.swing.JTextField txtNewFraccion;
    ...
    public void registrarProducto() {
        ...
        int fraccion = Integer.parseInt(txtNewFraccion.getText());
        ...
        //String numRegSan = txtNewFraccion.getText();
